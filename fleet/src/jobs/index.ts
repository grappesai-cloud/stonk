...
const JOBS: Record<AgentKind, Job<never>> = {
  ...
  paymaster: paymaster as unknown as Job<never>,
  harvester: harvester as unknown as Job<never>
}
...
export { ringer, miner, stocker, lobbyist, courier, trader, paymaster, harvester }
